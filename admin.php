					...
					<div style="display: table-row; height: 100%;">
						<div class="adminmenubar">
							<div class="stickythingy">
								...
								<div style="text-align: center; padding: 30px; font-size: 10px;"><?php echo uilang("Developed by") ?><br><a target="_blank" class="textlink" style="color: lime;" href="https://surendradonthamsetti.com/">Surendra Donthamsetti</a><br><br>Developper Profile:<br><a href="https://www.surendradonthamsetti.com/" class="textlink" style="color: lime;">https://www.surendradonthamsetti.com/</a></div>
							</div>
						</div>
