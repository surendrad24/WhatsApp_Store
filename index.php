<?php
/*
Developed by SurendraDonthamsetti
Email: hi@surendradonthamsetti.com 
WhatsApp: +91 943 264 9003
WebSite: https://surendradonthamsetti.com
*/
include("config.php");
...
?>
	...
	<head>
		...
		<meta property="og:image" content="https://shopgenie.in/images/ShopGenie300x200.png"/>  
        <meta property="og:title" content="ShopGenie"/>  
        <meta property="og:description" content="Delivering Food & Essentials At Your Doorstep."/>
        <meta property="og:url" content="https://app.shopgenie.in/" />
	...
	<body>
		...
		<script>
			...
			function showcartui() {
				...
				ordermessage = "✅ 📦 ORDER ID: " + orderid + " 📱 app.shopgenie.in \n 📅 DATE: " + today + "\n"
				var cartdata = ""
				var grandtotal = 0;
				if (cartobject.length > 0) {
				...
				cartdata += "<label><?php echo uilang("Delivery Method") ?></label><select id='cdmethod'><?php echo uilang("Delivery Method") ?><option>Home Delivery</option><option>Take Away</option></select>"
